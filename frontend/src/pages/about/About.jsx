        ...
        <div className={`${styles.aboutContainer} container`}>
          ...
          <div className={`${styles.aboutRow}`}>
            <div className={`${styles.aboutLeftCol}`}>
              ...
              <p className={`${styles.aboutLeftText}`}>AllStacks mission is to provide exceptional service to our customers by simplifying the process of developing your dream apps.</p>
